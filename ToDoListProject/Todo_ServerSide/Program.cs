...
app.MapGet("/items", async (ToDoDbContext dbContext) =>
{
    ...
    {
        Debug.WriteLine($"Error in GET /items: {ex.Message}");
...
app.MapPost("/items", async (Item item, ToDoDbContext dbContext) =>
{
    ...
    {
        Debug.WriteLine($"Error in POST /items: {ex.Message}");
        return Results.Problem("An error occurred while adding the item.");
    }
});
...
app.MapPut("/items/{id}", async (int id, Item updatedItem, ToDoDbContext dbContext) =>
{
    ...
    {
        Debug.WriteLine($"Error in PUT /items/{id}: {ex.Message}");
...
app.MapDelete("/items/{id}", async (int id, ToDoDbContext dbContext) =>
{
    ...
    {
        Debug.WriteLine($"Error in DELETE /items/{id}: {ex.Message}");
